...
const Review = (props) =>{
    ...
    return (
        ...
        <Grid width="900px" margin="0px auto">
            <Grid is_flex >
                <Grid> 
                    <p>총 <span color="#ff7c98">{props.postCnt} 53</span>건이 검색되었습니다.</p>
                </Grid>
                <Grid is_flex> 
                    <Select name="search">
                    ...
                    <Input />
                    <Button width= "115px" height ="34px" bg="#d3c1ab" radius="3px"
                        margin="0 0 0 3px"
                ...
                {review_list.map((p,idx) => { 
                    return (
                            ...
                            <Grid is flex margin="0 auto">
                                <TR>
                                    <TD width="72px" height="75px" margin="10px 20px" >{idx}</TD>
                                    <TD width="85%" height="75px"  >{p.title}</TD>
                                    <TD width="91px" height="75px" margin="5px" >{p.date}</TD>
                                </TR>
                                </Grid>
            ...
            <Grid is_flex margin="0px auto" width="100%">
                <Grid is_flex padding="30px 228px" >
                    ...
                    <Button _onClick={() => { movePage() }} shape="circle" bg="#ff7c98">1</Button>
                    <Button _onClick={() => { movePage() }} shape="circle" >2</Button>
                    <Button _onClick={() => { movePage() }} shape="circle" >3</Button>
                    <Button _onClick={() => { movePage() }} shape="circle" >4</Button>
                    {/*<ArrowButton onClick={ () => { moveFourPagesNext() } } icon_url={next_btn}></ArrowButton>*/}
                </Grid> 
                <Grid margin="0 300px 0 0">
                    <Button _onClick={() => { openModal() }} width= "115px" height ="34px" bg="#d3c1ab" radius="3px"
                        >글쓰기</Button>

                </Grid>  
            
            </Grid>
            <Modal open={ modalOpen } close={ closeModal } header="리뷰 작성하기">
