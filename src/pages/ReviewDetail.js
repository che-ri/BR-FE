...
const ReviewDetail = (props) => {
    ...
    console.log("useConfirm",userConfirm)
    ...
    return (
        ...
        {open ? (
            <section>
                ...
                <main>
                    <Grid center padding="20px 200px">
                        <Text size="17px" margin="10px 0px">제목🍧
                        </Text>
                        <Text >
                    ...
                    <Grid center padding="20px 200px">
                        <Text size="17px" margin="10px 0px">내용🍧
                        </Text>
                        <Text>
